...
//         chai.request(server)
//             .get(`${message}/specific/${details.firstMessageId}`)
//             .set('Authorization', `${details.rotimiToken}`)
//             .send(theMessage)
//             .end((req, res) => {
...
//                 expect(res.body.data[0]).to.have.own.property('id', `${details.firstMessageId}`);
...
//             .delete(`${message}/multiple`)
//             .set('Authorization', `${details.rotimiToken}`)
//             .send({ ids: [`${details.firstMessageId}, ${details.secondMessageId}`], type: 'sent' })
//             .end((req, res) => {
//                 res.should.have.status(200);
//                 res.body.should.be.json;
...
//             .delete(`${message}/multiple`)
//             .set('Authorization', `${details.rotimiToken}`)
//             .send({ ids: [`${details.firstMessageId}, ${details.thirdMessageId}`], type: 'sent' })
//             .end((req, res) => {
//                 res.body.should.be.json;
//                 res.should.have.status(200);
//                 expect(res.body).to.have.own.property('error' `Valid Messages have been deleted but you do not have messages with id = ${details.firstMessageId}`);
//                 done();
//             })
//     });
